public class Bug extends Invertebrate {
    ...
    Bug(String name, String hair, String feathers, String eggs, String milk, String airborne, String aquatic, String venomous, String fins, String legs, String tail, String class_type) {
    ...
    public String speak() {
        return "\t Quote: I have " + numberofLegs + " legs. " + numberofLegs + " legs best!";
    }
