public class Bird extends Vertebrate {
    ...
    Bird(String name, String hair, String feathers, String eggs, String milk, String airborne, String aquatic, String venomous, String fins, String legs, String tail, String class_type) {
    ...
    public String speak() {
        return super.speak() + " But have wings.";
    }
