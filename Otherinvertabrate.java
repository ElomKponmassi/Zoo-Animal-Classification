public class Otherinvertabrate extends Invertebrate {

    public String name;
    public String kind = "Other Invertebrate";
    ...
    Otherinvertabrate(String name, String hair, String feathers, String eggs, String milk, String airborne, String aquatic, String venomous, String fins, String legs, String tail, String class_type) {
    ...
    public String speak() {
        if (numberofLegs != 0) {
            return "\t Quote: Legs??? I have no need! Oh wait, I have " + numberofLegs + "!";
        } else return "\t Quote: Legs??? I have no need!";
    }
